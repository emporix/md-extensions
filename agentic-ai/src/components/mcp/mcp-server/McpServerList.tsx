...
export const McpServerList: React.FC<McpServerListProps> = React.memo(
  ({ mcpServers, onDelete, onEdit, onUpdate, onCancelEdit, editingIndex }) => {
                ...
                <div className="mcp-server-row-top">
                  ...
                  {server.type === 'predefined' && server.domain && (
                    <span className="mcp-server-mcp">
                      {MCP_SERVERS[server.domain]?.name}
                    </span>
                  )}
                  {server.type === 'custom' && (
                    <span className="mcp-server-custom-name">
                      {server.name}
                    </span>
                  )}
                ...
                {server.type === 'custom' && (
                  <div className="mcp-server-custom-details">
                    ...
                    <div className="mcp-server-custom-row">
                      <span className="mcp-server-tool-chip">
