const TRANSLATIONS_DE = {
  ...
  failed_to_fetch_logs: 'Logs konnten nicht geladen werden',
  failed_to_fetch_jobs: 'Jobs konnten nicht geladen werden',
  failed_to_fetch_sessions: 'Sitzungen konnten nicht geladen werden',
  failed_to_fetch_log_details: 'Log-Details konnten nicht geladen werden',
