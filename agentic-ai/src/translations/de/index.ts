const TRANSLATIONS_DE = {
  ...
  oauth_detail_subtitle:
    'OAuth für die Authentifizierung selbst gehosteter LLMs konfigurieren.',
  oauth_id: 'OAuth-ID',
  ...
  error_connecting_oauth: 'Fehler beim Verbinden der OAuth-Konfiguration',
  save_and_connect: 'Speichern & Verbinden',
  oauth_code_challenge_method: 'Code-Challenge-Methode',
  select_oauth_code_challenge_method: 'Code-Challenge-Methode auswählen',
  code_challenge_method_s256: 'S256',
  oauth_connection_status: 'Verbindungsstatus',
  oauth_status_pending: 'Ausstehend',
  oauth_status_connected: 'Verbunden',
  oauth_status_expired: 'Abgelaufen',
  oauth_status_revoked: 'Widerrufen',
  ...
  enter_oauth_token_url: 'OAuth-Token-URL eingeben',
  oauth_authorization_url: 'Authorize-URL',
  enter_oauth_url: 'OAuth-Token-URL eingeben',
  enter_oauth_authorize_url: 'OAuth-Authorize-URL eingeben',
