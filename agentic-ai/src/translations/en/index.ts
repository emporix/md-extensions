const TRANSLATIONS_EN = {
  ...
  oauth_detail_subtitle:
    'Configure OAuth for self-hosted LLM authentication.',
  oauth_id: 'OAuth ID',
  ...
  error_connecting_oauth: 'Error connecting OAuth configuration',
  save_and_connect: 'Save & Connect',
  oauth_code_challenge_method: 'Code Challenge Method',
  select_oauth_code_challenge_method: 'Select code challenge method',
  code_challenge_method_s256: 'S256',
  oauth_connection_status: 'Connection Status',
  ...
  enter_oauth_token_url: 'Enter OAuth token URL',
  oauth_authorization_url: 'Authorization URL',
  enter_oauth_url: 'Enter OAuth token URL',
  enter_oauth_authorize_url: 'Enter OAuth authorize URL',
