...
/** Numeric column filters in DataTable (see MD `NumberFilterTemplate`). */
export type NumberFilterMode = "equals" | "gt" | "lt";

export const isNumberFilterValue = (
  value: unknown,
): value is { value: number; mode: NumberFilterMode } =>
  typeof value === "object" &&
  value !== null &&
  "mode" in value &&
  "value" in value;
