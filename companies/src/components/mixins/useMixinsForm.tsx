...
interface MixinsProps {
  ...
  /** Mixin schema ids that currently have merge conflicts (customer edit Phase 2 UX). */
  mergeConflictMixinIds?: readonly string[];
}
        ...
        <TabPanel
          header={
            <MixinsTabTitle
              ...
              mergeConflict={
                props.mergeConflictMixinIds?.includes(f.id) ?? false
              }
              mergeConflictLabel={t("customers.tabs.mergeConflictIndicator")}
            />
          }
          key={f.id}
        >
