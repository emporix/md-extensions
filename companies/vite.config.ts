...
export default defineConfig({
  /**
   * Plain `vite` dev does not produce a real federated remoteEntry for @originjs/vite-plugin-federation.
   * For MD, use `yarn serve:prod` or `yarn build:prod:watch` + `vite preview`.
   */
  server: {
    cors: corsAllowlist,
  },
