...
export const EMPLOYEE_DOMAINS: Domain[] = [
  ...
  {
    id: EmployeeDomains.MEDIA_VIEWER,
    accessControls: [AccessControlsForEmployee.MEDIA_VIEWER],
  },
  {
    id: EmployeeDomains.MEDIA_MANAGER,
    accessControls: [AccessControlsForEmployee.MEDIA_MANAGER],
  },
  {
