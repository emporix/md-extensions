...
| 2026-08-03 | Post-migration verify (COP-6096): federation triangle + MD Mode A envs pass; develop/stage Firebase sites exist; prod site still needs IAM to create `emporix-customer-groups` | Treat preview green as proof prod hosting exists | customer-groups |
